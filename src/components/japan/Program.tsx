  ...
  },
  {
    ...
    text: (
      <>
        ...
        районами з деревʼяними будинками, маленькими майстернями та храмами. <b>Кіото</b>{" "}
  ...
  },
  {
    ...
    text: (
      <>
        ...
        ногами, сотні вогнів. Завершуємо день груповою рефлексією та спільними фото. Наступного дня
        виліт з Токіо
      </>
    ),
    ...
    <section id="program" className="relative py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-ink/70 text-lg">Щодня нові локації, нова їжа, нові емоції</p>
        </div>
