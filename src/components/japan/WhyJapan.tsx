const reasons = [
  { kanji: "安", title: "Абсолютна безпека", text: "Найбезпечніша країна у світі — статистично та відчутно." },
  { kanji: "質", title: "Передбачувана якість", text: "Сервіс, транспорт, готелі — все працює, як годинник." },
  { kanji: "心", title: "Глибина культури", text: "Тисячолітні традиції поруч із гіпермодерном." },
];
          ...
          <div>
            ...
            <div className="mt-8 inline-flex items-center gap-4 rounded-3xl bg-card border-2 border-primary p-6 shadow-card">
              ...
              <div className="text-ink/80 text-sm max-w-[220px]">
                мандрівників відвідують Японію вдруге та більше
              </div>
            </div>
          </div>
