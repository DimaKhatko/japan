      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="mt-6 text-xl text-ink/80 text-balance">
            Це унікальна японська філософія гостинності: передбачити потреби
            гостя <span className="text-primary font-semibold">ще до того, як він про них подумає</span>.
          </p>
          <p className="mt-4 text-ink/70">
            Ми переймаємо її у кожній деталі поїздки — від ранкової кави до
            нічного трансферу. Ви просто живете подорож. Решту беремо ми.
          </p>
        </div>
      </div>
    </section>
